...
interface IStatefulDocumentDeltaStorageEvents extends IEvent {
    (event: "connected" | "disconnected", listener: () => void);
}

interface IStatefulDocumentDeltaStorage extends IEventProvider<IStatefulDocumentDeltaStorageEvents> {
    connected: boolean;
...
class StatefulDocumentDeltaStorage
